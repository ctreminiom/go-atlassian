...
func TestSpaceService_Gets(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			endpoint:           "/wiki/rest/api/space?expand=operations&favorite=true&favouriteUserKey=DUMMY&label=label-09%2Clabel-02&limit=50&spaceId=1111&spaceId=2222&spaceId=3333&spaceKey=DUMMY&spaceKey=TEST&start=0&status=archived&type=global",
