...
func (p *ProjectRoleActorService) Add(ctx context.Context, projectKeyOrID, projectRoleID string, accountIDs, groups []string) (result *ProjectRoleDetailScheme, response *Response, err error) {
...
func (p *ProjectRoleActorService) Delete(ctx context.Context, projectKeyOrID, projectRoleID, accountID, group string) (response *Response, err error) {
