...
func TestFilterShareService_Add_V2(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			filterID:           10010,
			mockFile:           "../v3/mocks/add_share_filter_permission_group.json",
			wantHTTPMethod:     http.MethodPost,
			endpoint:           "/rest/api/2/filter/10010/permission",
		...
		},
		{
			...
			filterID:           10010,
			mockFile:           "../v3/mocks/add_share_filter_permission_project.json",
			wantHTTPMethod:     http.MethodPost,
			endpoint:           "/rest/api/2/filter/10010/permission",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusCreated,
		...
		},
		{
			...
			filterID:           10010,
			mockFile:           "../v3/mocks/add_share_filter_permission_project_and_role.json",
			wantHTTPMethod:     http.MethodPost,
			endpoint:           "/rest/api/2/filter/10010/permission",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusCreated,
		...
		},
		{
			...
			mockFile:           "../v3/mocks/add_share_filter_permission_project_and_role.json",
			wantHTTPMethod:     http.MethodPost,
			endpoint:           "/rest/api/2/filter/10010/permissiosdasdn",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusCreated,
			wantErr:            true,
		},
...
func TestFilterShareService_Delete_V2(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			endpoint:           "/rest/api/2/filter/10010/permission/1111",
			context:            context.Background(),
...
func TestFilterShareService_Get_V2(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			filterID:           10000,
			mockFile:           "../v3/mocks/get_share_permission.json",
			permissionID:       1111,
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/2/filter/10000/permission/1111",
			context:            context.Background(),
...
func TestFilterShareService_Gets_V2(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			filterID:           10000,
			mockFile:           "../v3/mocks/get_share_permissions.json",
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/2/filter/10000/permission",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},
...
func TestFilterShareService_Scope_V2(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			defaultScope:       "GLOBAL",
			mockFile:           "../v3/mocks/get_default_share_scope.json",
			wantHTTPMethod:     http.MethodGet,
...
func TestFilterShareService_SetScope_V2(t *testing.T) {
