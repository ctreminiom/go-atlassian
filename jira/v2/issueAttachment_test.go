...
func TestAttachmentService_Download_V2(t *testing.T) {
	testCases := []struct {
		name               string
		attachmentID       string
		redirect           bool
		...
		{
			name:               "DownloadAttachmentWhenTheAttachmentIDIsCorrect",
			mockFile:           "../../static/gitbook-logo.svg",
			attachmentID:       "10006",
			redirect:           false,
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/2/attachment/content/10006?redirect=false",
		...
		{
			name:               "DownloadAttachmentWhenTheAttachmentIDIsNotProvided",
			mockFile:           "../../static/gitbook-logo.svg",
			attachmentID:       "",
			redirect:           false,
			wantHTTPMethod:     http.MethodGet,
		...
		{
			name:               "DownloadAttachmentWhenTheContextIsNotProvided",
			mockFile:           "../../static/gitbook-logo.svg",
			attachmentID:       "10006",
			redirect:           false,
			wantHTTPMethod:     http.MethodGet,
		...
		{
			name:               "DownloadAttachmentWhenTheRequestMethodIsDifferent",
			mockFile:           "../../static/gitbook-logo.svg",
			attachmentID:       "10006",
			redirect:           false,
	...
	for _, testCase := range testCases {
		t.Run(testCase.name, func(t *testing.T) {
			...
			gotResponse, err := service.Download(testCase.context, testCase.attachmentID, testCase.redirect)
...
func TestAttachmentService_Delete_V2(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			endpoint:           "/rest/api/2/attachment/10006",
			context:            context.Background(),
...
func TestAttachmentService_Human_V2(t *testing.T) {
	testCases := []struct {
		name               string
		attachmentID       string
		mockFile           string
	...
	}{
		{
			...
			mockFile:           "../v3/mocks/get-attachment-human-view.json",
			attachmentID:       "10006",
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/2/attachment/10006/expand/human",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},
...
func TestAttachmentService_Metadata_V2(t *testing.T) {
	testCases := []struct {
		name               string
		attachmentID       string
		mockFile           string
	...
	}{
		{
			...
			mockFile:           "../v3/mocks/get-attachment-metadata.json",
			attachmentID:       "10006",
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/2/attachment/10006",
			context:            context.Background(),
...
func TestAttachmentService_Settings_V2(t *testing.T) {
	testCases := []struct {
		name               string
		mockFile           string
		wantHTTPMethod     string
...
func TestAttachmentService_Add_V2(t *testing.T) {

	absolutePathMocked, err := filepath.Abs("../v3/mocks/image.png")
	if err != nil {
		t.Fatal(err)
	}
	...
	testCases := []struct {
	...
	}{
		{
			...
			mockFile:           "../v3/mocks/get-attachments.json",
			issueKeyOrID:       "KP-1",
			fileName:           "image.png",
			file:               fileMocked,
			context:            context.Background(),
			wantHTTPMethod:     http.MethodPost,
			endpoint:           "/rest/api/2/issue/KP-1/attachments",
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},
