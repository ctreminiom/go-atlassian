...
// Official Docs: https://developer.atlassian.com/cloud/jira/platform/rest/v2/api-group-issue-fields/#api-rest-api-2-field-get
func (f *FieldService) Gets(ctx context.Context) (result []*models.IssueFieldScheme, response *ResponseScheme, err error) {

	var endpoint = "rest/api/2/field"
...
// Official Docs: https://developer.atlassian.com/cloud/jira/platform/rest/v2/api-group-issue-fields/#api-rest-api-2-field-post
...
// Official Docs: https://developer.atlassian.com/cloud/jira/platform/rest/v2/api-group-issue-fields/#api-rest-api-2-field-search-get
...
func (f *FieldService) Search(ctx context.Context, options *models.FieldSearchOptionsScheme, startAt, maxResults int) (
	...
	var endpoint = fmt.Sprintf("rest/api/2/field/search?%v", params.Encode())
...
func (f *FieldService) Delete(ctx context.Context, fieldId string) (result *models.TaskScheme, response *ResponseScheme,
	...
	endpoint := fmt.Sprintf("rest/api/2/field/%v", fieldId)
