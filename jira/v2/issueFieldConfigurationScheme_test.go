...
func Test_Field_Configuration_Scheme_Service_Delete(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			endpoint:           "/rest/api/2/fieldconfigurationscheme/1000",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusNoContent,
			wantErr:            false,
		},
...
func Test_Field_Configuration_Scheme_Service_Gets(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/2/fieldconfigurationscheme?id=1000&id=1001&id=1002&maxResults=100&startAt=50",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
			expectedError:      "",
...
func Test_Field_Configuration_Scheme_Service_Link(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			wantHTTPMethod:     http.MethodPut,
			endpoint:           "/rest/api/2/fieldconfigurationscheme/1000/mapping",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusNoContent,
			wantErr:            false,
		},
...
func Test_Field_Configuration_Scheme_Service_Mapping(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/2/fieldconfigurationscheme/mapping?fieldConfigurationSchemeId=1000&fieldConfigurationSchemeId=1001&fieldConfigurationSchemeId=1002&maxResults=100&startAt=50",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
			expectedError:      "",
...
func Test_Field_Configuration_Scheme_Service_Project(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/2/fieldconfigurationscheme/project?maxResults=100&projectId=1000&projectId=1001&projectId=1002&startAt=50",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
			expectedError:      "",
...
func Test_Field_Configuration_Scheme_Service_Unlink(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			wantHTTPMethod:     http.MethodPost,
			endpoint:           "/rest/api/2/fieldconfigurationscheme/1000/mapping/delete",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusNoContent,
			wantErr:            false,
		},
...
func Test_Field_Configuration_Scheme_Service_Update(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			fieldConfigurationSchemeName:        "field configuration description",
			wantHTTPMethod:                      http.MethodPut,
			endpoint:                            "/rest/api/2/fieldconfigurationscheme/100",
			context:                             context.Background(),
			wantHTTPCodeReturn:                  http.StatusOK,
			wantErr:                             false,
		},
