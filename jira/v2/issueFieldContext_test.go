...
func TestFieldContextService_Create(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			mockFile:           "../v3/mocks/create-issue-field-context.json",
			endpoint:           "/rest/api/2/field/100/context",
...
func TestFieldContextService_Gets(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			startAt:            0,
			maxResult:          50,
			mockFile:           "../v3/mocks/issue-field-contexts.json",
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/2/field/100/context?contextId=10000&isAnyIssueType=true&isGlobalContext=true&maxResults=50&startAt=0",
			context:            context.Background(),
		...
		},
		{
			...
			mockFile:           "../v3/mocks/issue-field-contexts.json",
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/2/fields/100/context?contextId=10000&isAnyIssueType=true&isGlobalContext=true&maxResults=50&startAt=0",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            true,
		},
...
func TestFieldContextService_AddIssueTypes(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			endpoint:           "/rest/api/2/field/customfield_10002/context/2001/issuetype",
			context:            context.Background(),
...
func TestFieldContextService_Delete(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			contextID:          2001,
			wantHTTPMethod:     http.MethodDelete,
			endpoint:           "/rest/api/2/field/customfield_10002/context/2001",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusNoContent,
			wantErr:            false,
		},
...
func TestFieldContextService_GetDefaultValues(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			startAt:            0,
			maxResults:         50,
			mockFile:           "../v3/mocks/get-custom-field-default-values.json",
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/2/field/customfield_10002/context/defaultValue?contextId=1001&contextId=1002&maxResults=50&startAt=0",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},

		{
			...
			mockFile:           "../v3/mocks/get-custom-field-default-values.json",
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/2/field/customfield_10002/context/defaultValue?maxResults=50&startAt=0",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},
...
func TestFieldContextService_IssueTypesContext(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			startAt:            0,
			maxResults:         50,
			mockFile:           "../v3/mocks/get-issue-field-context-issue-type-contexts.json",
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/2/field/customfield_10002/context/issuetypemapping?contextId=1001&contextId=1002&maxResults=50&startAt=0",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},

		{
			...
			mockFile:           "../v3/mocks/get-issue-field-context-issue-type-contexts.json",
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/2/field/customfield_10002/context/issuetypemapping?maxResults=50&startAt=0",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},
...
func TestFieldContextService_Projects(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			startAt:            0,
			maxResults:         50,
			mockFile:           "../v3/mocks/get-issue-field-context-project-mapping.json",
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/2/field/customfield_10002/context/projectmapping?contextId=1001&contextId=1002&maxResults=50&startAt=0",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},

		{
			...
			mockFile:           "../v3/mocks/get-issue-field-context-project-mapping.json",
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/2/field/customfield_10002/context/projectmapping?maxResults=50&startAt=0",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},
...
func TestFieldContextService_Link(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			fieldID:            "customfield_10002",
			contextID:          2001,
			projectIDs:         []string{"10001", "10002", "10002"},
			wantHTTPMethod:     http.MethodPut,
			endpoint:           "/rest/api/2/field/customfield_10002/context/2001/project",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusNoContent,
			wantErr:            false,
		},
...
func TestFieldContextService_RemoveIssueTypes(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			fieldID:            "customfield_10002",
			contextID:          2001,
			issueTypesIDs:      []string{"10001", "10002", "10002"},
			wantHTTPMethod:     http.MethodPost,
			endpoint:           "/rest/api/2/field/customfield_10002/context/2001/issuetype/remove",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusNoContent,
			wantErr:            false,
		},
...
func TestFieldContextService_SetDefaultValue(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			wantHTTPMethod:     http.MethodPut,
			endpoint:           "/rest/api/2/field/customfield_10002/context/defaultValue",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusNoContent,
			wantErr:            false,
		},
...
func TestFieldContextService_UnLink(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			projectIDs:         []string{"10001", "10002", "10002"},
			wantHTTPMethod:     http.MethodPost,
			endpoint:           "/rest/api/2/field/customfield_10002/context/2001/project/remove",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusNoContent,
			wantErr:            false,
		},
