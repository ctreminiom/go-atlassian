...
func TestFieldService_Restore(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			endpoint:           "/rest/api/2/field/10001/restore",
	...
	for _, testCase := range testCases {
		t.Run(testCase.name, func(t *testing.T) {
			...
			gotResponse, err := service.Restore(testCase.context, testCase.fieldId)
...
func TestFieldService_Trash(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			fieldId:            "10001",
			wantHTTPMethod:     http.MethodPost,
			endpoint:           "/rest/api/2/field/10001/trash",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},
	...
	for _, testCase := range testCases {
		t.Run(testCase.name, func(t *testing.T) {
			...
			gotResponse, err := service.Trash(testCase.context, testCase.fieldId)
...
func TestFieldService_Delete(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			endpoint:           "/rest/api/2/field/10001",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},
...
func TestFieldService_Create(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			mockFile:           "../v3/mocks/field-created.json",
			wantHTTPMethod:     http.MethodPost,
...
func TestFieldService_Gets(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name:               "GetFields",
			mockFile:           "../v3/mocks/get-fields.json",
...
func TestFieldService_Search(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			startAt:            0,
			maxResults:         50,
			mockFile:           "../v3/mocks/search-fields.json",
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/2/field/search?expand=screensCount%2ClastUsed&id=111%2C12222&maxResults=50&orderBy=lastUsed&query=query-sample&startAt=0&type=custom",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},
		{
			...
			mockFile:           "../v3/mocks/search-fields.json",
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/2/field/search?expand=screensCount%2ClastUsed&maxResults=50&orderBy=lastUsed&startAt=0&type=custom",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            true,
		},
		...
		},
		{
			...
			startAt:            0,
			maxResults:         50,
			mockFile:           "../v3/mocks/get-fields.json.json",
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/2/field/search?expand=screensCount%2ClastUsed&maxResults=50&orderBy=lastUsed&startAt=0&type=custom",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
