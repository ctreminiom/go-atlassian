...
func (i *IssueTypeScreenSchemeService) Create(ctx context.Context, payload *models.IssueTypeScreenSchemePayloadScheme) (
	...
	var endpoint = "rest/api/2/issuetypescreenscheme"
...
// Atlassian Docs: https://developer.atlassian.com/cloud/jira/platform/rest/v2/api-group-issue-type-screen-schemes/#api-rest-api-2-issuetypescreenscheme-project-put
func (i *IssueTypeScreenSchemeService) Assign(ctx context.Context, issueTypeScreenSchemeID, projectID string) (
	...
	var endpoint = "rest/api/2/issuetypescreenscheme/project"
...
func (i *IssueTypeScreenSchemeService) Projects(ctx context.Context, projectIDs []int, startAt, maxResults int) (
	...
	var endpoint = fmt.Sprintf("rest/api/2/issuetypescreenscheme/project?%v", params.Encode())
...
func (i *IssueTypeScreenSchemeService) Mapping(ctx context.Context, issueTypeScreenSchemeIDs []int, startAt, maxResults int) (
	...
	var endpoint = fmt.Sprintf("rest/api/2/issuetypescreenscheme/mapping?%v", params.Encode())
...
// Atlassian Docs; https://developer.atlassian.com/cloud/jira/platform/rest/v2/api-group-issue-type-screen-schemes/#api-rest-api-2-issuetypescreenscheme-issuetypescreenschemeid-put
...
// Atlassian Docs: https://developer.atlassian.com/cloud/jira/platform/rest/v2/api-group-issue-type-screen-schemes/#api-rest-api-2-issuetypescreenscheme-issuetypescreenschemeid-delete
...
func (i *IssueTypeScreenSchemeService) Append(ctx context.Context, issueTypeScreenSchemeID string,
	...
	var endpoint = fmt.Sprintf("rest/api/2/issuetypescreenscheme/%v/mapping", issueTypeScreenSchemeID)
...
// Atlassian Docs: https://developer.atlassian.com/cloud/jira/platform/rest/v2/api-group-issue-type-screen-schemes/#api-rest-api-2-issuetypescreenscheme-issuetypescreenschemeid-mapping-default-put
...
// Atlassian Docs: https://developer.atlassian.com/cloud/jira/platform/rest/v2/api-group-issue-type-screen-schemes/#api-rest-api-2-issuetypescreenscheme-issuetypescreenschemeid-mapping-remove-post
...
func (i *IssueTypeScreenSchemeService) SchemesByProject(ctx context.Context, issueTypeScreenSchemeID int, startAt,
	...
	var endpoint = fmt.Sprintf("rest/api/2/issuetypescreenscheme/%v/project?%v", issueTypeScreenSchemeID, params.Encode())
