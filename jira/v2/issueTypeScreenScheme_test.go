...
func TestIssueTypeScreenSchemeService_Append(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			endpoint:           "/rest/api/2/issuetypescreenscheme/10000/mapping",
...

		{
			...
			wantHTTPMethod:     http.MethodPut,
			endpoint:           "/rest/api/2/issuetypescreenschemes/10000/mapping",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusNoContent,
			wantErr:            true,
		},
...
func TestIssueTypeScreenSchemeService_Assign(t *testing.T) {
	...
	testCases := []struct {
...

		{
			...
			projectID:               "10001",
			wantHTTPMethod:          http.MethodPut,
			endpoint:                "/rest/api/2/issuetypescreenscheme/projects",
			context:                 context.Background(),
			wantHTTPCodeReturn:      http.StatusNoContent,
			wantErr:                 true,
		},
...
func TestIssueTypeScreenSchemeService_Create(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			mockFile:           "../v3/mocks/create-issue-type-screen-scheme.json",
...

		{
			...
			mockFile:           "../v3/mocks/create-issue-type-screen-scheme-not-string.json",
			wantHTTPMethod:     http.MethodPost,
			endpoint:           "/rest/api/2/issuetypescreenscheme",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusCreated,
...

		{
			...
			mockFile:           "../v3/mocks/create-issue-type-screen-scheme.json",
			wantHTTPMethod:     http.MethodPost,
			endpoint:           "/rest/apis/2/issuetypescreenscheme",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusCreated,
			wantErr:            true,
		},
...
func TestIssueTypeScreenSchemeService_Delete(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			issueTypeScreenSchemeID: "10000",
			wantHTTPMethod:          http.MethodDelete,
			endpoint:                "/rest/api/2/issuetypescreenscheme/10000",
			context:                 context.Background(),
			wantHTTPCodeReturn:      http.StatusNoContent,
			wantErr:                 false,
		},
...
func TestIssueTypeScreenSchemeService_Update(t *testing.T) {
	...
	testCases := []struct {
...

		{
			...
			description:               "New issue type scheme description",
			wantHTTPMethod:            http.MethodPut,
			endpoint:                  "/rest/api/2/issuetypescreenscheme/10001",
			context:                   context.Background(),
			wantHTTPCodeReturn:        http.StatusNoContent,
			wantErr:                   true,
		},
...
func TestIssueTypeScreenSchemeService_UpdateDefault(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			wantHTTPMethod:          http.MethodPut,
			endpoint:                "/rest/api/2/issuetypescreenscheme/10000/mapping/default",
			context:                 context.Background(),
			wantHTTPCodeReturn:      http.StatusNoContent,
			wantErr:                 false,
		},
...
func TestIssueTypeScreenSchemeService_Remove(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			wantHTTPMethod:          http.MethodPost,
			endpoint:                "/rest/api/2/issuetypescreenscheme/10000/mapping/remove",
			context:                 context.Background(),
			wantHTTPCodeReturn:      http.StatusNoContent,
			wantErr:                 false,
		},
...
func TestIssueTypeScreenSchemeService_Mapping(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			startAt:                  0,
			maxResults:               50,
			mockFile:                 "../v3/mocks/get-issue-type-screen-scheme-items.json",
			wantHTTPMethod:           http.MethodGet,
			endpoint:                 "/rest/api/2/issuetypescreenscheme/mapping?issueTypeScreenSchemeId=1000&issueTypeScreenSchemeId=1001&maxResults=50&startAt=0",
			context:                  context.Background(),
			wantHTTPCodeReturn:       http.StatusOK,
			wantErr:                  false,
		},
...
func TestIssueTypeScreenSchemeService_Projects(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			startAt:            0,
			maxResults:         50,
			mockFile:           "../v3/mocks/get-issue-type-screen-schemes-for-projects.json",
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/2/issuetypescreenscheme/project?maxResults=50&projectId=1000&projectId=1001&startAt=0",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},
...
func TestIssueTypeScreenSchemeService_SchemesByProject(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			startAt:                 0,
			maxResults:              50,
			mockFile:                "../v3/mocks/get-issue-type-screen-schemes-by-project.json",
			wantHTTPMethod:          http.MethodGet,
			endpoint:                "/rest/api/2/issuetypescreenscheme/1000/project?maxResults=50&startAt=0",
			context:                 context.Background(),
			wantHTTPCodeReturn:      http.StatusOK,
			wantErr:                 false,
		},
