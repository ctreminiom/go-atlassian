...
func TestWatcherService_Add(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			endpoint:           "/rest/api/2/issue/DUMMY-2/watchers",
...

		{
			...
			issueKeyOrID:       "DUMMY-2",
			wantHTTPMethod:     http.MethodPost,
			endpoint:           "/rest/api/2/issue/DUMMY-2/watcher",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusNoContent,
			wantErr:            true,
		},
...
func TestWatcherService_Delete(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			issueKeyOrID:       "DUMMY-2",
			accountID:          "e75fa4ab-c86b-4500-b522-de962f21b928",
			wantHTTPMethod:     http.MethodDelete,
			endpoint:           "/rest/api/2/issue/DUMMY-2/watchers?accountId=e75fa4ab-c86b-4500-b522-de962f21b928",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusNoContent,
			wantErr:            false,
		},
...

		{
			...
			issueKeyOrID:       "DUMMY-2",
			wantHTTPMethod:     http.MethodDelete,
			endpoint:           "/rest/api/2/issue/DUMMY-2/watchers?aaccountId=e75fa4ab-c86b-4500-b522-de962f21b928",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusNoContent,
			wantErr:            true,
		},
...
func TestWatcherService_Get(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			endpoint:           "/rest/api/2/issue/DUMMY-2/watchers",
			mockFile:           "../v3/mocks/get-issue-watchers.json",
			context:            context.Background(),
...

		{
			...
			issueKeyOrID:       "DUMMY-2",
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/2/issue/DUMMY-2/vote",
			mockFile:           "../v3/mocks/get-issue-watchers.json",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            true,
