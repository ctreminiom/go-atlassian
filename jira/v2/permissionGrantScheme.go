...
func (p *PermissionGrantSchemeService) Gets(ctx context.Context, permissionSchemeID int, expand []string) (
	...
	endpoint.WriteString(fmt.Sprintf("rest/api/2/permissionscheme/%v/permission", permissionSchemeID))
...
func (p *PermissionGrantSchemeService) Get(ctx context.Context, permissionSchemeID, permissionGrantID int, expand []string) (
	...
	var endpoint strings.Builder
	endpoint.WriteString(fmt.Sprintf("rest/api/2/permissionscheme/%v/permission/%v", permissionSchemeID, permissionGrantID))
...
// Atlassian Docs: https://developer.atlassian.com/cloud/jira/platform/rest/v2/api-group-permission-schemes/#api-rest-api-2-permissionscheme-schemeid-permission-permissionid-delete
