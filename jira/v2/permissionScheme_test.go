...
func TestPermissionSchemeService_Create(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			mockFile:           "../v3/mocks/get-permission-scheme.json",
...

		{
			...
			mockFile:           "../v3/mocks/get-permission-scheme.json",
			wantHTTPMethod:     http.MethodPost,
			endpoint:           "/rest/apis/2/permissionscheme",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusCreated,
			wantErr:            true,
		},
...
func TestPermissionSchemeService_Delete(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			endpoint:           "/rest/api/2/permissionscheme/1000",
			context:            context.Background(),
...

		{
			...
			permissionSchemeID: 1000,
			wantHTTPMethod:     http.MethodDelete,
			endpoint:           "/rest/api/2/permissionscheme/1001",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusNoContent,
			wantErr:            true,
		},
...
func TestPermissionSchemeService_Get(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			endpoint:           "/rest/api/2/permissionscheme/1000?expand=all",
			mockFile:           "../v3/mocks/get-permission-scheme.json",
			context:            context.Background(),
			expand:             []string{"all"},
...

		{
			...
			permissionSchemeID: 1000,
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/2/permissionschemes/1000",
			mockFile:           "../v3/mocks/get-permission-scheme.json",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            true,
...
func TestPermissionSchemeService_Gets(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/2/permissionscheme",
			mockFile:           "../v3/mocks/get-permission-schemes.json",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},
