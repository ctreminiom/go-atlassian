...
func TestProjectComponentService_Count(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			componentID:        "1001",
			mockFile:           "../v3/mocks/get-project-component-count.json",
...
func TestProjectComponentService_Create(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			mockFile:           "../v3/mocks/get-project-component.json",
...
func TestProjectComponentService_Delete(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			mockFile:           "../v3/mocks/get-project-component.json",
			wantHTTPMethod:     http.MethodDelete,
			endpoint:           "/rest/api/2/component/1001",
			context:            context.Background(),
...
func TestProjectComponentService_Gets(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			mockFile:           "../v3/mocks/get-project-components.json",
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/2/project/DUMMY/components",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},
