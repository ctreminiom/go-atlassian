...
func TestProjectRoleActorService_Add(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			projectRoleID:      1001,
			accountIDs:         []string{"17bbc4fc-88ba-40a8-b28d-8a5afecaf820", "f019b08b-5faf-4691-b0c2-ce057212001a"},
			groups:             []string{"jira-users", "jira-developers"},
			mockFile:           "../v3/mocks/create-project-role-actor.json",
...
func TestProjectRoleActorService_Delete(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			projectKeyOrID:     "DUMMY",
			projectRoleID:      1001,
			accountID:          "17bbc4fc-88ba-40a8-b28d-8a5afecaf820",
			group:              "jira-developers",
			wantHTTPMethod:     http.MethodDelete,
			endpoint:           "/rest/api/2/project/DUMMY/role/1001?group=jira-developers&user=17bbc4fc-88ba-40a8-b28d-8a5afecaf820",
			context:            context.Background(),
