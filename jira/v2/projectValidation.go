...
// Atlassian Docs: https://developer.atlassian.com/cloud/jira/platform/rest/v2/api-group-project-key-and-name-validation/#api-rest-api-2-projectvalidate-key-get
func (p *ProjectValidationService) Validate(ctx context.Context, projectKey string) (result *models2.ProjectValidationMessageScheme,
	...
	var endpoint = fmt.Sprintf("rest/api/2/projectvalidate/key?%v", params.Encode())
...
// Atlassian Docs: https://developer.atlassian.com/cloud/jira/platform/rest/v2/api-group-project-key-and-name-validation/#api-rest-api-2-projectvalidate-validprojectkey-get
func (p *ProjectValidationService) Key(ctx context.Context, projectKey string) (randomKey string, response *ResponseScheme,
	...
	var endpoint = fmt.Sprintf("rest/api/2/projectvalidate/validProjectKey?%v", params.Encode())
...
// Atlassian Docs: https://developer.atlassian.com/cloud/jira/platform/rest/v2/api-group-project-key-and-name-validation/#api-rest-api-2-projectvalidate-validprojectname-get
func (p *ProjectValidationService) Name(ctx context.Context, projectName string) (randomName string,
	...
	var endpoint = fmt.Sprintf("rest/api/2/projectvalidate/validProjectName?%v", params.Encode())
