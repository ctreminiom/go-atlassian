...
func TestScreenTabService_Create(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			mockFile:           "../v3/mocks/create-screen-tab.json",
			wantHTTPMethod:     http.MethodPost,
			endpoint:           "/rest/api/2/screens/10001/tabs",
...
func TestScreenTabService_Gets(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			screenID:           10001,
			projectKey:         "DUMMY",
			mockFile:           "../v3/mocks/get-screen-tabs.json",
...
func TestScreenTabService_Move(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			tabPosition:        21,
			wantHTTPMethod:     http.MethodPost,
			endpoint:           "/rest/api/2/screens/10001/tabs/1001/move/21",
			context:            context.Background(),
