...
func TestScreenService_AddToDefault(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			endpoint:           "/rest/api/2/screens/addToDefault/customfield_10022",
...
func TestScreenService_Available(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			screenID:           10001,
			mockFile:           "../v3/mocks/get-available-screen-fields.json",
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/2/screens/10001/availableFields",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},
...
func TestScreenService_Create(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			mockFile:           "../v3/mocks/create-screen.json",
			wantHTTPMethod:     http.MethodPost,
...
func TestScreenService_Get(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			startAt:            0,
			maxResults:         50,
			mockFile:           "../v3/mocks/get-screens-for-field.json",
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/2/field/customfield_10022/screens?maxResults=50&startAt=0",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},
...
func TestScreenService_Gets(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			startAt:            0,
			maxResults:         50,
			mockFile:           "../v3/mocks/get-screens.json",
			wantHTTPMethod:     http.MethodGet,
...

		{
			...
			mockFile:           "../v3/mocks/get-screens.json",
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/2/screens?maxResults=50&startAt=0",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},
...
func TestScreenService_Update(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			mockFile:           "../v3/mocks/update-screen.json",
