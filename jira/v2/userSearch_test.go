...
func TestUserSearchService_Projects(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			accountID:          "594b47b5-c774-4d51-9ee8-b604012e9d9a",
			projectKeys:        []string{"DUMMY", "FK", "PS"},
			startAt:            0,
			maxResults:         50,
			mockFile:           "../v3/mocks/find-users-assignable-to-projects.json",
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/2/user/assignable/multiProjectSearch?accountId=594b47b5-c774-4d51-9ee8-b604012e9d9a&maxResults=50&projectKeys=DUMMY%2CFK%2CPS&startAt=0",
...
func TestUserSearchService_Do(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			startAt:            0,
			maxResults:         50,
			mockFile:           "../v3/mocks/search-users.json",
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/2/user/search?accountId=594b47b5-c774-4d51-9ee8-b604012e9d9a&maxResults=50&query=charlie&startAt=0",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},

		{
			...
			endpoint:           "/rest/api/2/user/search?accountId=594b47b5-c774-4d51-9ee8-b604012e9d9a&maxResults=50&startAt=0",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            true,
		},
