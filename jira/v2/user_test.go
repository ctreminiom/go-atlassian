...
func TestUserService_Create(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			mockFile:           "../v3/mocks/create-user.json",
...
func TestUserService_Delete(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			wantHTTPMethod:     http.MethodDelete,
			endpoint:           "/rest/api/2/user?accountId=c5f6fccf-9195-4a50-82d0-a7c4ce5a5b78",
			context:            context.Background(),
...
func TestUserService_Find(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			accountIDs:         []string{"aa2098e2-8c1c-498a-b67f-5c2f52c271cd", "f79c7c0c-9266-4acc-9a79-2e21762b1d29"},
			startAt:            0,
			maxResults:         50,
			mockFile:           "../v3/mocks/find-users.json",
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/2/user/bulk?accountId=aa2098e2-8c1c-498a-b67f-5c2f52c271cd&accountId=f79c7c0c-9266-4acc-9a79-2e21762b1d29&maxResults=50&startAt=0",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},
...
func TestUserService_Get(t *testing.T) {
	...
	testCases := []struct {
...

		{
			...
			mockFile:           "../v3/mocks/create-user.json",
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/2/user?accountId=5b10ac8d82e05b22cc7d4ef5",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},
...
func TestUserService_Gets(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			startAt:            0,
			maxResults:         50,
			mockFile:           "../v3/mocks/get-users.json",
			wantHTTPMethod:     http.MethodGet,
...
func TestUserService_Groups(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			accountID:          "5b10ac8d82e05b22cc7d4ef5",
			mockFile:           "../v3/mocks/get-user-groups.json",
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/2/user/groups?accountId=5b10ac8d82e05b22cc7d4ef5",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},
