...
func TestWorkflowSchemeService_Create(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			mockFile: "../mocks/get-workflow-scheme.json",
			payload: &models.WorkflowSchemePayloadScheme{
...
func TestWorkflowSchemeService_Get(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			endpoint:           "/rest/api/2/workflowscheme/1006?returnDraftIfExists=true",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},
...
func TestWorkflowSchemeService_Update(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			endpoint:           "/rest/api/2/workflowscheme/1006",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},
...
func TestWorkflowSchemeService_Gets(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/2/workflowscheme?maxResults=50&startAt=0",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},
...
func TestWorkflowSchemeService_Associations(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/2/workflowscheme/project?projectId=10001&projectId=10002&projectId=10003",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},
