...
func (i *IssueService) Creates(ctx context.Context, payload []*models.IssueBulkSchemeV3) (result *models.IssueBulkResponseScheme,
...
func (i *IssueService) Move(ctx context.Context, issueKeyOrID, transitionID string, options *models.IssueMoveOptionsV3) (
	response *ResponseScheme, err error) {
