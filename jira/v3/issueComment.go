...
func (c *CommentService) Gets(ctx context.Context, issueKeyOrID, orderBy string, expand []string, startAt,
	maxResults int) (result *models.IssueCommentPageScheme, response *ResponseScheme, err error) {
...
func (c *CommentService) Get(ctx context.Context, issueKeyOrID, commentID string) (result *models.IssueCommentScheme,
...
func (c *CommentService) Add(ctx context.Context, issueKeyOrID string, payload *models.CommentPayloadScheme, expand []string) (
	result *models.IssueCommentScheme, response *ResponseScheme, err error) {
