...
func (c *CommentService) Gets(ctx context.Context, issueKeyOrID, orderBy string, expand []string, startAt,
	maxResults int) (result *models2.IssueCommentPageScheme, response *ResponseScheme, err error) {
...
func (c *CommentService) Get(ctx context.Context, issueKeyOrID, commentID string) (result *models2.IssueCommentScheme,
...
func (c *CommentService) Add(ctx context.Context, issueKeyOrID string, payload *models2.CommentPayloadScheme, expand []string) (
	result *models2.IssueCommentScheme, response *ResponseScheme, err error) {
