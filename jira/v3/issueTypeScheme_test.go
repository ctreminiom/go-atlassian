...
func TestIssueTypeSchemeService_AddIssueTypes(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			endpoint:           "/rest/api/3/issuetypescheme/1000/issuetype",
...

		{
			...
			issueTypeIDs:       []int{10001, 10002},
			wantHTTPMethod:     http.MethodPut,
			endpoint:           "/rest/api/3/issuetypescheme/1000/issuetypes",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusNoContent,
			wantErr:            true,
		},
...
func TestIssueTypeSchemeService_Assign(t *testing.T) {
	...
	testCases := []struct {
...

		{
			...
			wantHTTPMethod:     http.MethodPut,
			mockFile:           "",
			endpoint:           "est/api/3/issuetypescheme/project",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusNoContent,
			wantErr:            true,
		},

		{
			...
			wantHTTPMethod:     http.MethodPut,
			mockFile:           "",
			endpoint:           "/rest/api/3/issuetypescheme/projects",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusNoContent,
			wantErr:            true,
		},
...
func TestIssueTypeSchemeService_Create(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			mockFile:           "./mocks/create-issue-type-scheme.json",
			wantHTTPMethod:     http.MethodPost,
...

		{
			...
			mockFile:           "./mocks/create-issue-type-scheme.json",
			wantHTTPMethod:     http.MethodPost,
			endpoint:           "/rest/api/3/issuetypeschemes",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusCreated,
			wantErr:            true,
		},
...
func TestIssueTypeSchemeService_Gets(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			mockFile:           "./mocks/get-issue-type-schemes.json",
			endpoint:           "/rest/api/3/issuetypescheme?id=10000&id=10001&id=10002&maxResults=50&startAt=0",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusCreated,
			wantErr:            false,
		},

		{
			...
			wantHTTPMethod:     http.MethodGet,
			mockFile:           "./mocks/get-issue-type-schemes.json",
			endpoint:           "/rest/api/3/issuetypescheme?maxResults=50&startAt=0",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusCreated,
			wantErr:            false,
		},

		{
			...
			wantHTTPMethod:     http.MethodGet,
			mockFile:           "./mocks/get-issue-type-schemes.json",
			endpoint:           "/rest/api/3/issuetypeschemes?id=10000&id=10001&id=10002&maxResults=50&startAt=0",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusCreated,
			wantErr:            true,
		},
...
func TestIssueTypeSchemeService_Items(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			maxResults:         50,
			wantHTTPMethod:     http.MethodGet,
			mockFile:           "./mocks/get-issue-type-scheme-items.json",
			endpoint:           "/rest/api/3/issuetypescheme/mapping?issueTypeSchemeId=10000&issueTypeSchemeId=10001&issueTypeSchemeId=10002&maxResults=50&startAt=0",
			context:            context.Background(),
...

		{
			...
			wantHTTPMethod:     http.MethodGet,
			mockFile:           "./mocks/get-issue-type-scheme-items.json",
			endpoint:           "/rest/api/3/issuetypescheme/mapping?maxResults=50&startAt=0",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},

		{
			...
			wantHTTPMethod:     http.MethodGet,
			mockFile:           "./mocks/get-issue-type-scheme-items.json",
			endpoint:           "/rest/api/3/issuetypeschemes/mapping?issueTypeSchemeId=10000&issueTypeSchemeId=10001&issueTypeSchemeId=10002&maxResults=50&startAt=0",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            true,
		},
...
func TestIssueTypeSchemeService_Projects(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			maxResults:         50,
			wantHTTPMethod:     http.MethodGet,
			mockFile:           "./mocks/get-issue-types-schemes-for-projects.json",
			endpoint:           "/rest/api/3/issuetypescheme/project?maxResults=50&projectId=10000&projectId=10001&projectId=10002&startAt=0",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},
...

		{
			...
			wantHTTPMethod:     http.MethodGet,
			mockFile:           "./mocks/get-issue-types-schemes-for-projects.json",
			endpoint:           "/rest/api/3/issuetypeschemes/project?maxResults=50&projectId=10000&projectId=10001&projectId=10002&startAt=0",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            true,
		},
...
func TestIssueTypeSchemeService_RemoveIssueType(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			issueTypeID:        10001,
			wantHTTPMethod:     http.MethodDelete,
			endpoint:           "/rest/api/3/issuetypescheme/1000/issuetype/10001",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusNoContent,
			wantErr:            false,
		},
