...
func TestIssueWorklogService_Issue(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			mockFile:           "./mocks/get-issue-worklogs.json",
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/3/issue/KP-1/worklog?expand=expand%2Cnow&maxResults=50&startAt=0&startedAfter=11112",
...
func TestIssueWorklogService_Get(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/3/issue/KP-1/worklog/10000?expand=all",
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},
...
func TestIssueWorklogService_Deleted(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			ctx:                context.Background(),
			since:              1000202,
			mockFile:           "./mocks/get-issue-worklogs-changelogs.json",
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/3/worklog/deleted?since=1000202",
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},
...
func TestIssueWorklogService_Updated(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			mockFile:           "./mocks/get-issue-worklogs-changelogs.json",
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/3/worklog/updated?expand=all&since=1000202",
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},
...
func TestIssueWorklogService_Gets(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			expand:             []string{"expand", "now"},
			mockFile:           "./mocks/get-worklogs.json",
			wantHTTPMethod:     http.MethodPost,
			endpoint:           "/rest/api/3/worklog/list?expand=expand%2Cnow",
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},
