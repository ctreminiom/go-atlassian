...
func TestIssueScheme_MergeCustomFields(t *testing.T) {
	...
	testCases := []struct {
		...
		issuePayload *models2.IssueScheme
		wantErr      bool
	}{
		{
			name: "MergeCustomFieldsWhenTheCustomFieldsAreValue",
			issuePayload: &models2.IssueScheme{
				Fields: &models2.IssueFieldsScheme{
...
func TestIssueService_Creates(t *testing.T) {
	...
	var newIssuePayloadMockWithCustomFields00 = models2.IssueBulkSchemeV3{
		Payload: &models2.IssueScheme{
			Fields: &models2.IssueFieldsScheme{
				Summary:   "New summary test",
				Project:   &models2.ProjectScheme{ID: "10000"},
	...
	var newIssuePayloadMockWithCustomFields01 = models2.IssueBulkSchemeV3{
		Payload: &models2.IssueScheme{
			Fields: &models2.IssueFieldsScheme{
				Summary:   "New summary test",
				Project:   &models2.ProjectScheme{ID: "10000"},
	...
	var newIssuePayloadMockWithCustomFieldsValueAsNil = models2.IssueBulkSchemeV3{
		Payload: &models2.IssueScheme{
			Fields: &models2.IssueFieldsScheme{
				Summary:   "New summary test",
				Project:   &models2.ProjectScheme{ID: "10000"},
	...
	var newIssuePayloadMockWithOutCustomFields00 = models2.IssueBulkSchemeV3{
		Payload: &models2.IssueScheme{
			Fields: &models2.IssueFieldsScheme{
				Summary:   "New summary test",
				Project:   &models2.ProjectScheme{ID: "10000"},
	...
	var newIssuePayloadMockWithOutCustomFields01 = models2.IssueBulkSchemeV3{
		Payload: &models2.IssueScheme{
			Fields: &models2.IssueFieldsScheme{
				Summary:   "New summary test",
				Project:   &models2.ProjectScheme{ID: "10000"},
	...
	var newIssuePayloadMockWithPayloadIsNil = models2.IssueBulkSchemeV3{
		Payload:      nil,
		CustomFields: &customFieldMockedWithOutFields,
	}

	var payloadMockWithCorrectPayloads []*models2.IssueBulkSchemeV3
	...
	var payloadMockWithIncorrectPayloads []*models2.IssueBulkSchemeV3
	...
	var payloadMockWithNilPayloads []*models2.IssueBulkSchemeV3
	...
	testCases := []struct {
		name               string
		payload            []*models2.IssueBulkSchemeV3
		mockFile           string
		wantHTTPMethod     string
		endpoint           string
		context            context.Context
...
func TestIssueService_Move(t *testing.T) {
	...
	var payload = &models2.IssueScheme{
		Fields: &models2.IssueFieldsScheme{
	...
	testCases := []struct {
		...
		issueKeyOrID       string
		transitionID       string
		options            *models2.IssueMoveOptionsV3
		mockFile           string
		wantHTTPMethod     string
		endpoint           string
		context            context.Context
