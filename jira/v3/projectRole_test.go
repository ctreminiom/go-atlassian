...
func TestProjectRoleService_Details(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			mockFile:           "./mocks/get-project-role-details.json",
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/3/project/DUMMY/roledetails",
			context:            context.Background(),
...
func TestProjectRoleService_Get(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			mockFile:           "./mocks/get-project-role.json",
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/3/project/DUMMY/role/1000",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},
...
func TestProjectRoleService_Gets(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			projectKeyOrID:     "DUMMY",
			mockFile:           "./mocks/get-project-roles.json",
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/3/project/DUMMY/role",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},

		{
			...
			projectKeyOrID:     "DUMMY",
			mockFile:           "./mocks/get-project-roles-when-the-ids-are-string.json",
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/3/project/DUMMY/role",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
...

		{
			...
			projectKeyOrID:     "DUMMY",
			mockFile:           "./mocks/get-project-roles-when-the-urls-are-incorrect.json",
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/3/project/DUMMY/role",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
		...
		{
			name:               "GetProjectRolesWhenTheEndpointIsIncorrect",
			projectKeyOrID:     "DUMMY",
			mockFile:           "./mocks/get-project-roles.json",
			wantHTTPMethod:     http.MethodGet,
...
func TestProjectRoleService_Global(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			mockFile:           "./mocks/get-project-global-roles.json",
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/3/role",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
		...
		{
			name:               "GetGlobalProjectRolesWhenTheEndpointIsIncorrect",
			mockFile:           "./mocks/get-project-global-roles.json",
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/2/role",
			context:            context.Background(),
