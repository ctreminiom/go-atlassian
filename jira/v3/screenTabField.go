...
func (s *ScreenTabFieldService) Gets(ctx context.Context, screenID, tabID int) (result []*models2.ScreenTabFieldScheme,
...
func (s *ScreenTabFieldService) Add(ctx context.Context, screenID, tabID int, fieldID string) (result *models2.ScreenTabFieldScheme,
	response *ResponseScheme, err error) {
