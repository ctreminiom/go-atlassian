...
var (
	...
	ErrInvalidContentType             = errors.New("confluence: invalid content type: (page, comment, attachment)")
	...
	ErrNoGroupID                      = errors.New("jira: no group name set")
	...
	ErrNilPayload                     = errors.New("client: please provide the necessary payload struct")
	ErrNonPayloadPointer              = errors.New("client: please provide a valid payload struct pointer (&)")
	ErrNoFieldInformation             = errors.New("custom-field: please provide a buffer with a valid fields object")
	ErrNoCustomFieldUnmarshal         = errors.New("custom-field: no valid json provided")
	...
	ErrNoAttachmentIds                = errors.New("sm: no attachment id's set")
	ErrNoLabels                       = errors.New("sm: no label names set")
