...
type Epic interface {
	...
	Get(ctx context.Context, epic string) (*model.EpicScheme, *model.ResponseScheme, error)
	...
	Issues(ctx context.Context, epic string, startAt, maxResults int, opts *model.IssueOptionScheme) (*model.BoardIssuePageScheme,
	...
	Move(ctx context.Context, epic string, issues []string) (*model.ResponseScheme, error)
}
